...
public class CheckIsPalindromeWithArraysTests
{
    private readonly PalindromesChecker _palindromesChecker;
    public CheckIsPalindromeWithArraysTests()
    {
    ...
    {
        var result = _palindromesChecker.CheckIsPalindromeWithArrays(lowerCaseOnlyReadableSignsTextToCheck);
        Assert.True(result);
    }
    [Theory]
    [InlineData("")]
